...
export namespace CardController {
    ...
    export async function getSongCard(req: Request, res: Response) {
        try {
            const card = await createSongCard(String(req.query.author), String(req.query.title), String(req.query.start_at), String(req.query.end_at), String(req.query.station), String(req.query.playing), String(req.query.image));
    ...
    export async function createSongCard(author: string, title: string, start_at: string, end_at: string, station: string, playing: string, image: string) {
